...
//When we create an object of CountDownLatch, we specify the number if threads it should wait for, all such thread are required to do count down by calling CountDownLatch.countDown() once they are completed or ready to the job. 
...
class Worker extends Thread {
	...
	public void run() {
		try {
			Thread.sleep(delay);
			latch.countDown();//every worker thread should decrement the value.
